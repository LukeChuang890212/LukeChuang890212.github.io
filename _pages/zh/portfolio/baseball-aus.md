...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%); padding: 30px; border-radius: 12px; margin-bottom: 30px; color: #e0e0e0;">
  ...
  <p style="font-size: 1.1em; line-height: 1.7; color: #f5f5f5;">
    主審的好球帶公平嗎？透過逐球數據與 Kernel Density Estimation，我重建了 <strong>Omar Peralta 每半局的實際好球帶</strong>，量化 2026 年世界棒球經典賽中這場令人難忘比賽的主審偏差。
  </p>
</div>

## 研究問題

在棒球中，規則好球帶有明確定義——但主審實際判定的*好球帶*會因每顆球而異。當一支球隊懷疑判決不一致時，數據能夠說明一切。在 2026 WBC C組台灣與澳洲的精彩對決之後，我著手回答：**兩隊面對的好球帶判定是否一致？**

## 資料來源與清理

- **逐球數據**：台澳戰中所有判定球（好球與壞球，不含揮棒）的球位座標數據（水平與垂直座標，以英尺為單位，從捕手視角）。
- 共分析 **142 顆判定球**：台灣打擊時 75 顆，澳洲打擊時 67 顆。
- 每顆球標記為判定好球或判定壞球，並與規則好球帶邊界進行交叉比對。

## 方法

- **二維 Kernel Density Estimation（KDE）**：對判定好球位置套用 Gaussian KDE，分別估計兩隊打擊時主審的實際好球帶等高線。
- **準確度分類**：將每顆判定球歸類為四種類型——正確好球、正確壞球、慷慨好球（好球帶外被判好球）與錯誤壞球（好球帶內被判壞球）。
- **好球帶差異圖**：計算差異熱力圖（台灣好球帶機率減去澳洲好球帶機率），以視覺化空間偏差。
- **等高線比較**：將兩隊的 50% 機率等高線疊加在規則好球帶上，突顯形狀與大小差異。
...
<div style="display: flex; flex-wrap: wrap; gap: 20px; margin: 25px 0;">
  <div style="flex: 1; min-width: 250px; background: #fff3f3; border-left: 5px solid #e94560; padding: 20px; border-radius: 8px;">
    ...
    <p>主審的好球帶<strong>大幅擴張</strong>——幾乎向每個方向膨脹。好球帶的形狀不規則到幾乎像澳洲地圖。<strong>近三分之二的錯誤判決不利於台灣</strong>。</p>
  </div>
  <div style="flex: 1; min-width: 250px; background: #f0f7ff; border-left: 5px solid #3498db; padding: 20px; border-radius: 8px;">
    ...
    <p>好球帶收縮成一個<strong>扁平、狹窄的矩形</strong>。低球幾乎全被判壞球，迫使台灣投手提高球路——使他們在高位好球帶更容易被擊中。</p>
  </div>
</div>
...
<p style="color: #666; font-size: 0.95em;">KDE 估計的好球帶（陰影等高線）與規則好球帶（虛線矩形）的比較。台灣打擊時（左），好球帶明顯超出規則邊界。澳洲打擊時（右），好球帶縮小——特別是在底部邊緣。</p>
...
<p style="color: #666; font-size: 0.95em;"><strong>紅色 = 台灣打擊時好球機率較高；藍色 = 澳洲打擊時好球機率較高。</strong>紅色區域佔主導地位，證實台灣打擊時的有效好球帶在幾乎所有位置都明顯更大。</p>
...
數據清楚地呈現了事實。台灣打擊時，主審的好球帶向外膨脹——將明顯偏離好球帶的球判定為好球。77% 的準確率以職業水準來說明顯偏低。最關鍵的是，錯誤是**不對稱的**：台灣打擊時，慷慨好球（不利打者的錯誤判決）與錯誤壞球的比例接近 5:1。

澳洲打擊時，好球帶急劇收緊。底部邊緣基本消失——對台灣打者會被判好球的低球，此時幾乎都被判為壞球。這可能迫使台灣投手提高球路，增加被強勁擊球的風險。
