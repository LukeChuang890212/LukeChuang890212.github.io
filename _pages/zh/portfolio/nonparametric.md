...
<div style="background: linear-gradient(135deg, #064e3b 0%, #047857 50%, #34d399 100%); padding: 30px; border-radius: 12px; margin-bottom: 30px; color: #e0e0e0;">
  <h2 style="color: #a7f3d0; margin-top: 0; font-size: 1.6em;">不做假設？完全沒問題。</h2>
  <p style="font-size: 1.1em; line-height: 1.7; color: #f5f5f5;">
    當參數模型過於死板時，<strong>無母數方法</strong>讓資料自己說話。從 Kernel Density Estimation 到 <strong>GAMs</strong>——在 <strong>9 份報告</strong>中全面探索無需分配假設的曲線估計方法。
  </p>
</div>
...
<div style="display: flex; flex-wrap: wrap; gap: 20px; margin: 20px 0;">
  <div style="flex: 1; min-width: 300px; background: #ecfdf5; border-left: 5px solid #34d399; padding: 20px; border-radius: 8px;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 10px;">
      ...
      <div style="background: white; padding: 8px; border-radius: 6px; text-align: center; font-size: 0.9em;">
        <strong style="color: #047857;">多元</strong><br><span style="color: #666;">乘積核函數</span>
      </div>
      <div style="background: white; padding: 8px; border-radius: 6px; text-align: center; font-size: 0.9em;">
  ...
  <div style="flex: 1; min-width: 300px; background: #f0fdf4; border-left: 5px solid #22c55e; padding: 20px; border-radius: 8px;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 10px;">
      ...
      <div style="background: white; padding: 8px; border-radius: 6px; text-align: center; font-size: 0.9em;">
        <strong style="color: #15803d;">GAMs</strong><br><span style="color: #666;">廣義可加模型（mgcv）</span>
      </div>
      <div style="background: white; padding: 8px; border-radius: 6px; text-align: center; font-size: 0.9em;">
        <strong style="color: #15803d;">Mixed Model</strong><br><span style="color: #666;">Spline 與隨機效應的聯繫</span>
      </div>
    </div>
  </div>
</div>
...
<div style="background: #1a1a2e; padding: 25px; border-radius: 12px; margin: 20px 0; text-align: center;">
  ...
  <p style="color: #aaa; font-size: 1.1em; margin-top: 5px;">核心洞見：平滑程度比平滑方式更重要</p>
  <div style="display: flex; justify-content: center; gap: 40px; margin-top: 20px; flex-wrap: wrap;">
    ...
    <div><span style="font-size: 1.8em; font-weight: bold; color: #7fecb3;">Local Linear</span><br><span style="color: #aaa;">無邊界偏差</span></div>
    <div><span style="font-size: 1.8em; font-weight: bold; color: #7fecb3;">9 份報告</span><br><span style="color: #aaa;">全面涵蓋</span></div>
  </div>
</div>

- 資料驅動的 Bandwidth 選擇方法始終優於固定 Bandwidth 的做法。
- Kernel 的選擇（Gaussian vs. Epanechnikov）影響遠小於 Bandwidth——**偏差-變異數權衡**才是核心。
- Local Linear 迴歸避免了 Nadaraya-Watson 估計量的邊界偏差問題。
- 搭配 GCV 的 Smoothing Splines 兼顧了擬合精度與防止過度擬合。
- **GAMs** 成功捕捉了多個預測變數中的非線性關係。
