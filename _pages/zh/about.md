...
<div style="display: flex; flex-wrap: wrap; gap: 15px; margin: 20px 0;">
  <div style="flex: 1; min-width: 180px; background: #eff6ff; border: 2px solid #2563eb; padding: 18px; border-radius: 10px; text-align: center;">
    ...
    <p style="margin: 8px 0 0; font-size: 0.9em; color: #666;">針對不完整資料的穩健推論方法</p>
  </div>
  <div style="flex: 1; min-width: 180px; background: #eff6ff; border: 2px solid #2563eb; padding: 18px; border-radius: 10px; text-align: center;">
    <strong style="color: #1e3a5f; font-size: 1.15em;">Causal Inference</strong>
    <p style="margin: 8px 0 0; font-size: 0.9em; color: #666;">從相關性走向因果關係</p>
  </div>
  <div style="flex: 1; min-width: 180px; background: #eff6ff; border: 2px solid #2563eb; padding: 18px; border-radius: 10px; text-align: center;">
    <strong style="color: #1e3a5f; font-size: 1.15em;">Meta Analysis</strong>
    <p style="margin: 8px 0 0; font-size: 0.9em; color: #666;">整合多項研究的實證證據</p>
  </div>
</div>
...
<div style="background: #f8fafc; border-left: 5px solid #8b5cf6; padding: 20px; border-radius: 8px; margin: 20px 0;">
  <p style="color: #475569; line-height: 1.7; margin-top: 0;">
    大學時期在成功大學同時主修<strong>心理學</strong>與<strong>統計學</strong>，讓我養成了獨特的跨領域思維——既具備量化分析的嚴謹訓練，也擁有行為科學的直覺洞察。大學期間的研究橫跨棒球選手虛擬實境投球訓練、職棒觀眾入場意願分析，以及運用 Systems Factorial Technology 探討注意力焦點機制等主題。
  </p>
  <p style="color: #475569; line-height: 1.7; margin-bottom: 0;">
    在清華大學就讀期間，我擔任過 <strong>Statistical Learning</strong>、<strong>Survival Analysis</strong> 及統計學導論等課程的<strong>教學助理</strong>，並先後獲得<strong>培育優秀博士生獎學金</strong>與<strong>學業優良獎學金</strong>。
  </p>
</div>
